...
class TestPoint(unittest.TestCase):
    ...
    def test_init(self):
        self.assertEqual((self.A.x, self.A.y), (float(5), float(6)), "The obtained values are not real number!!!")
        self.assertEqual((self.B.x, self.B.y), (float(6), float(10)),
                         "The obtained values are not real number!!!")
        self.assertEqual((self.C.x, self.C.y), (float(5), float(6)), "The obtained values are not real number!!!")
    ...
    def test_eq(self):
        ...
        self.assertFalse(self.A == self.B,
                         "These two points are unequal, but as a result of testing, they turned out to be equal!!!")
